...
- **Footer tagline removed (2026-09-22)** — Same-day follow-up to the header change: the tagline line under the footer lockup goes too, so no page displays it. The brief keeps it as the approved brand line for copy elsewhere (section 2), and 12.1a notes both lockups are mark + wordmark.
