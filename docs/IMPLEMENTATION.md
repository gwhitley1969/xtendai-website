...
|---|---|---|---|
| `beneath-hero-d.mp4` | loop, landscape (`(min-width: 1024px)`) | 0.70 MB | 1600×900, H.264 High L4.0, CRF 23, 24 fps; a 1.2 s tail-into-head crossfade closes the loop; the steady-lattice take of 2026-09-22 |
| `beneath-hero-m.mp4` | loop, portrait | 0.40 MB | 540×960, L3.1, CRF 24; crop window at 80% of the master's width, on the lattice |
...
| `beneath-hero-d.png` / `-m.png` | first frame of each loop rendition | 600 / 382 KB source | served as WebP (q70, largest variants 27 / 19 KB) under the clip: the LCP element |
