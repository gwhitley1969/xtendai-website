...
Decisions locked by the owner: the ambient backdrop stays (ride + loop, approved on sight); the phone becomes a tesseract with the mark + wordmark lockup at its core, reactive to the visitor; the lattice lights in the loop glow steadily (co-founder request, 2026-09-22); light pulses on the cube are off; the cube is a quarter larger than first built; every auto-playing motion carries the shared pause control.
